  ...
  static Future init() async {
    database ??= await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        await db.execute(
            'CREATE TABLE items (id INTEGER PRIMARY KEY, timeline_id INTEGER, year INTEGER, intro TEXT, title TEXT, image TEXT, links TEXT, image_source TEXT, image_info TEXT)');
      },
    );
  }
